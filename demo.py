...
# Sidebar inputs with proper filtering
car_companies = data['Original_equipment_manufacturer'].unique()

# Select Car Company
#oem = st.sidebar.selectbox("Select Car Company", car_companies)

# Filter models based on selected company
#filtered_models = data[data['Original_equipment_manufacturer'] == oem]['Model'].unique()

# Select Car Model
#model = st.sidebar.selectbox("Select Car Model", filtered_models)

# Filter variants based on selected model
#filtered_variants = data[(data['Original_equipment_manufacturer'] == oem) &
                         #(data['Model'] == model)]['Variant_name'].unique()

# Select Model Variant
#variant_name = st.sidebar.selectbox("Select Car Variant", filtered_variants)
